...
public class Streams13OfIterateGenerateDemo {
    ...
    public static void main(String[] args) {
         ...
         * 
         * iterate takes a seed value(initaial value) and a unaryoperator lambda expression.
         * 
        ...
        /*
         * A. Whenever we want to do some calculation with the value with got generated by the stream we go for iterate method.
         *     eg. I want even numbers. Stream.iterate(0, val->val+2);
         *     
         *    Whenever we just want to blindly supply values (andhaaaa), NO CALCULATION WITH THE RESULT. we go for generate method.
