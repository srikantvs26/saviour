...
public class Streams06ReduceDemo {
    public static void main(String[] args) {
        // reduce : this method is used to reduce the stream into a single
        // value.
        ...
        Optional<Student> studentWithHighestGPA = StudentDataBase
                .getAllStudents().stream().reduce((s1, s2) -> {
        ...
        Integer totalMul = Arrays.asList(1, 2, 3, 4, 5, 6, 7).stream().reduce(1,
                (num1, num2) -> num1 * num2);
        ...
        Optional<Integer> totalMulOp = Arrays.asList(1, 2, 3, 4, 5, 6, 7)
                .stream().reduce((num1, num2) -> num1 * num2);
