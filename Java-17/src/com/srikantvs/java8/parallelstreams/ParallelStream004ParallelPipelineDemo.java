...
public class ParallelStream004ParallelPipelineDemo {
    ...
    public static void main(String[] args) {
        ...
        // Time Taken : 2
        //
        // Why there is so much time difference ? : Run them individually. there will be no difference. wo ek baar already calculate kar
        // chuka hai na isliye 2nd wale me time kam aa raha hai.
