...
public class LocalVariableWithLambda01Demo {
    ...
    public static void main(String[] args) {
        ...
        // ->Comment1 Consumer<Integer> intConsumer =
        // (localVariable)->System.out.println(localVariable);

        Consumer<Integer> intConsumer1 = (somethingOtherthan_localVariable) -> System.out
                .println(somethingOtherthan_localVariable);
