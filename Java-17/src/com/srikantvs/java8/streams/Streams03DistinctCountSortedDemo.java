...
public class Streams03DistinctCountSortedDemo {
    ...
    public static void main(String[] args) {
        ...
        List<String> uniqueStudentActivities2 = StudentDataBase.getAllStudents()
                ...
                .flatMap(takeThatStudentList -> takeThatStudentList.stream())// here. it will become
                                                                             // <Stream<Stream<String>> but with that
                                                                             // flatmap one stream will be gone so we
                                                                             // will be end up with just Stream<String>
                .distinct()
                .sorted()
