...
public class Streams02FlatMapDemo {
        ...
        public static void main(String[] args) {
                ...
                // flatmap() : just like map it is used to transform the stream from one type to
                // another
                ...
                List<String> studentActivities = StudentDataBase.getAllStudents()
                                ...
                                .flatMap(studentActList -> studentActList.stream())// here. it will become
                                                                                   // <Stream<Stream<String>>
                                                                                   // but with that flatmap
                                                                                   // one stream will be gone
                                                                                   // so we will be end up
                                                                                   // with just Stream<String>
