package com.srikantvs.java8.generics.generic_methods_with_type_parameter;
...
public class Test4 {
    ...
    /**
     * T is Integer
     * m1 can be called ay any List of any type but it should be of Type Number or its super class like Object Integer Okay, Double Okay
     * We cannot add anything because we don't know what List l will be? Integer, Double
     * 
