...
public class Test2 {
     ...
     * 
     * We cannot add anything to l because we don't know the type of l we will be getting, List<Integer>, List<Double> etc.
     * 1st example T is Integer
     * Good for reading the values
     */
    public static <T> void m1(List<? super T> l) {
        l.add(null);
