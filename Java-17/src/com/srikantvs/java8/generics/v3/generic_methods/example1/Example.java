...
class A {
	...
	// <T> works for both static and non static methods, above methods for non
	// static methods
	...
	/**
	 * Here we have Generic method with type parameter T, where in we have specified
	 * a constraint that T must extend Comparable. Same T we have passed as return
	 * Type and in method parameters. findMax method will be called only when we
	 * pass an array of Integers, Double, Which implements Comparable Interface.
	 * 
	 * @param <T>
	 * @param a
	 * @return
	...
	/**
	 * Framework methods we have seen methods like these in Spring, Hibernate
	 * 
	 * @param <T>
	 * @param a
	 * @param c
...
public class Example extends A {
	...
	public static void main(String[] args) {
		...
		U[] us = { new U(), new U() };
		A.findMax(us); // Error because we have specified constraint that it has to implement
						// Comparable.

		canYouDigIt(new Integer[] { 1, 2, 3 }); // Yes Integer extends Number and respect the constraint applied on
												// canYouDigIt method
