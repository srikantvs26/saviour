...
public class Test2 {
	...
	/**
	 * We can see that, m1 method can be called by List of type Number. like List of
	 * type Integer, List of type Double etc. We can add null to the list l We
	 * cannot add any values to the list l, because we don't know the type of l
	 * which we will be getting from caller, it can be an List of Integers, List of
	 * Doubles etc.
	 * 
